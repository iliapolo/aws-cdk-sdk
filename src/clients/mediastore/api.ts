...
export class MediaStoreClient extends cdk.Construct {
  ...
  public createContainer(input: shapes.MediaStoreCreateContainerInput): MediaStoreCreateContainer {
    return new MediaStoreCreateContainer(this, 'CreateContainer', this.__resources, input);
  }
  ...
  public describeContainer(input: shapes.MediaStoreDescribeContainerInput): MediaStoreDescribeContainer {
    return new MediaStoreDescribeContainer(this, 'DescribeContainer', this.__resources, input);
  }

  public fetchContainerPolicy(input: shapes.MediaStoreGetContainerPolicyInput): MediaStoreFetchContainerPolicy {
    return new MediaStoreFetchContainerPolicy(this, 'FetchContainerPolicy', this.__resources, input);
  }

  public fetchCorsPolicy(input: shapes.MediaStoreGetCorsPolicyInput): MediaStoreFetchCorsPolicy {
    return new MediaStoreFetchCorsPolicy(this, 'FetchCorsPolicy', this.__resources, input);
  }

  public fetchLifecyclePolicy(input: shapes.MediaStoreGetLifecyclePolicyInput): MediaStoreFetchLifecyclePolicy {
    return new MediaStoreFetchLifecyclePolicy(this, 'FetchLifecyclePolicy', this.__resources, input);
  }

  public fetchMetricPolicy(input: shapes.MediaStoreGetMetricPolicyInput): MediaStoreFetchMetricPolicy {
    return new MediaStoreFetchMetricPolicy(this, 'FetchMetricPolicy', this.__resources, input);
  }

  public listContainers(input: shapes.MediaStoreListContainersInput): MediaStoreListContainers {
    return new MediaStoreListContainers(this, 'ListContainers', this.__resources, input);
  }

  public listTagsForResource(input: shapes.MediaStoreListTagsForResourceInput): MediaStoreListTagsForResource {
    return new MediaStoreListTagsForResource(this, 'ListTagsForResource', this.__resources, input);
  }
...
export class MediaStoreCreateContainer extends cdk.Construct {

  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.MediaStoreCreateContainerInput) {
    super(scope, id);
  }

  public get container(): MediaStoreCreateContainerContainer {
    return new MediaStoreCreateContainerContainer(this, 'Container', this.__resources, this.input);
  }

}

export class MediaStoreCreateContainerContainer extends cdk.Construct {
  ...
  public get endpoint(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'CreateContainer.Container.Endpoint', props);
  ...
  public get creationTime(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'CreateContainer.Container.CreationTime', props);
  ...
  public get arn(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'CreateContainer.Container.ARN', props);
  ...
  public get name(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'CreateContainer.Container.Name', props);
  ...
  public get status(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'CreateContainer.Container.Status', props);
  ...
  public get accessLoggingEnabled(): boolean {
    ...
    const resource = new cr.AwsCustomResource(this, 'CreateContainer.Container.AccessLoggingEnabled', props);
    return resource.getResponseField('Container.AccessLoggingEnabled') as unknown as boolean;
  }

}

export class MediaStoreDescribeContainer extends cdk.Construct {

  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.MediaStoreDescribeContainerInput) {
    super(scope, id);
  }

  public get container(): MediaStoreDescribeContainerContainer {
    return new MediaStoreDescribeContainerContainer(this, 'Container', this.__resources, this.input);
  }

}

export class MediaStoreDescribeContainerContainer extends cdk.Construct {
  ...
  public get endpoint(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'DescribeContainer.Container.Endpoint', props);
    return resource.getResponseField('Container.Endpoint') as unknown as string;
  }
  ...
  public get creationTime(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'DescribeContainer.Container.CreationTime', props);
    return resource.getResponseField('Container.CreationTime') as unknown as string;
  }
  ...
  public get arn(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'DescribeContainer.Container.ARN', props);
    return resource.getResponseField('Container.ARN') as unknown as string;
  }
  ...
  public get name(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'DescribeContainer.Container.Name', props);
    return resource.getResponseField('Container.Name') as unknown as string;
  }
  ...
  public get status(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'DescribeContainer.Container.Status', props);
    return resource.getResponseField('Container.Status') as unknown as string;
  }
  ...
  public get accessLoggingEnabled(): boolean {
    ...
    const resource = new cr.AwsCustomResource(this, 'DescribeContainer.Container.AccessLoggingEnabled', props);
    return resource.getResponseField('Container.AccessLoggingEnabled') as unknown as boolean;
  }

}

export class MediaStoreFetchContainerPolicy extends cdk.Construct {

  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.MediaStoreGetContainerPolicyInput) {
    super(scope, id);
  }
  ...
  public get policy(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'GetContainerPolicy.Policy', props);
    return resource.getResponseField('Policy') as unknown as string;
  }

}

export class MediaStoreFetchCorsPolicy extends cdk.Construct {

  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.MediaStoreGetCorsPolicyInput) {
    super(scope, id);
  }
  ...
  public get corsPolicy(): shapes.MediaStoreCorsRule[] {
    ...
    const resource = new cr.AwsCustomResource(this, 'GetCorsPolicy.CorsPolicy', props);
    return resource.getResponseField('CorsPolicy') as unknown as shapes.MediaStoreCorsRule[];
  }

}

export class MediaStoreFetchLifecyclePolicy extends cdk.Construct {

  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.MediaStoreGetLifecyclePolicyInput) {
    super(scope, id);
  }
  ...
  public get lifecyclePolicy(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'GetLifecyclePolicy.LifecyclePolicy', props);
    return resource.getResponseField('LifecyclePolicy') as unknown as string;
  }

}

export class MediaStoreFetchMetricPolicy extends cdk.Construct {

  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.MediaStoreGetMetricPolicyInput) {
    super(scope, id);
  }

  public get metricPolicy(): MediaStoreFetchMetricPolicyMetricPolicy {
    return new MediaStoreFetchMetricPolicyMetricPolicy(this, 'MetricPolicy', this.__resources, this.input);
  }

}

export class MediaStoreFetchMetricPolicyMetricPolicy extends cdk.Construct {
  ...
  public get containerLevelMetrics(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'GetMetricPolicy.MetricPolicy.ContainerLevelMetrics', props);
  ...
  public get metricPolicyRules(): shapes.MediaStoreMetricPolicyRule[] {
    ...
    const resource = new cr.AwsCustomResource(this, 'GetMetricPolicy.MetricPolicy.MetricPolicyRules', props);
    return resource.getResponseField('MetricPolicy.MetricPolicyRules') as unknown as shapes.MediaStoreMetricPolicyRule[];
  }

}

export class MediaStoreListContainers extends cdk.Construct {

  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.MediaStoreListContainersInput) {
    super(scope, id);
  }
  ...
  public get containers(): shapes.MediaStoreContainer[] {
    ...
    const resource = new cr.AwsCustomResource(this, 'ListContainers.Containers', props);
  ...
  public get nextToken(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'ListContainers.NextToken', props);
    return resource.getResponseField('NextToken') as unknown as string;
  }

}

export class MediaStoreListTagsForResource extends cdk.Construct {

  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.MediaStoreListTagsForResourceInput) {
    super(scope, id);
  }
