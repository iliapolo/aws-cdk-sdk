...
export class ApiGatewayManagementApiClient extends cdk.Construct {
  ...
  public fetchConnection(input: shapes.ApiGatewayManagementApiGetConnectionRequest): ApiGatewayManagementApiFetchConnection {
    return new ApiGatewayManagementApiFetchConnection(this, 'FetchConnection', this.__resources, input);
  }
...
export class ApiGatewayManagementApiFetchConnection extends cdk.Construct {

  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.ApiGatewayManagementApiGetConnectionRequest) {
    super(scope, id);
  }
  ...
  public get connectedAt(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'GetConnection.ConnectedAt', props);
    return resource.getResponseField('ConnectedAt') as unknown as string;
  }

  public get identity(): ApiGatewayManagementApiFetchConnectionIdentity {
    return new ApiGatewayManagementApiFetchConnectionIdentity(this, 'Identity', this.__resources, this.input);
  }
  ...
  public get lastActiveAt(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'GetConnection.LastActiveAt', props);
    return resource.getResponseField('LastActiveAt') as unknown as string;
  }

}

export class ApiGatewayManagementApiFetchConnectionIdentity extends cdk.Construct {
  ...
  public get sourceIp(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'GetConnection.Identity.SourceIp', props);
  ...
  public get userAgent(): string {
    ...
    const resource = new cr.AwsCustomResource(this, 'GetConnection.Identity.UserAgent', props);
