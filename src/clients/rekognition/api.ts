...
export class RekognitionCompareFaces extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionCompareFacesRequest) {
    super(scope, id);
  }

  public get sourceImageFace(): RekognitionCompareFacesSourceImageFace {
    return new RekognitionCompareFacesSourceImageFace(this, 'SourceImageFace', this.__resources, this.input);
  }
      ...
      onUpdate: {
        ...
        parameters: {
          SourceImage: {
            ...
            S3Object: {
              Bucket: this.input.sourceImage.s3Object?.bucket,
              Name: this.input.sourceImage.s3Object?.name,
              Version: this.input.sourceImage.s3Object?.version,
            },
          },
          TargetImage: {
            Bytes: {
            ...
            S3Object: {
              Bucket: this.input.targetImage.s3Object?.bucket,
              Name: this.input.targetImage.s3Object?.name,
              Version: this.input.targetImage.s3Object?.version,
            },
          },
          SimilarityThreshold: this.input.similarityThreshold,
          QualityFilter: this.input.qualityFilter,
        },
      },
    };
...
export class RekognitionCompareFacesSourceImageFace extends cdk.Construct {
  ...
  public get boundingBox(): RekognitionCompareFacesSourceImageFaceBoundingBox {
    return new RekognitionCompareFacesSourceImageFaceBoundingBox(this, 'BoundingBox', this.__resources, this.input);
  }
...
export class RekognitionCreateCollection extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionCreateCollectionRequest) {
    super(scope, id);
  }
  ...
  public get statusCode(): number {
    const props: cr.AwsCustomResourceProps = {
      ...
      onUpdate: {
        ...
        parameters: {
          CollectionId: this.input.collectionId,
        },
      },
    };
...
export class RekognitionCreateProject extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionCreateProjectRequest) {
    super(scope, id);
  }
...
export class RekognitionCreateProjectVersion extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionCreateProjectVersionRequest) {
    super(scope, id);
  }
      ...
      onUpdate: {
        ...
        parameters: {
          ...
          OutputConfig: {
            ...
            S3KeyPrefix: this.input.outputConfig.s3KeyPrefix,
          },
          TrainingData: {
            Assets: this.input.trainingData.assets,
          },
          TestingData: {
            Assets: this.input.testingData.assets,
            AutoCreate: this.input.testingData.autoCreate,
          },
        },
      },
    };
...
export class RekognitionCreateStreamProcessor extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionCreateStreamProcessorRequest) {
    super(scope, id);
  }
    ...
    const props: cr.AwsCustomResourceProps = {
      ...
      onUpdate: {
        ...
        parameters: {
          Input: {
            KinesisVideoStream: {
              Arn: this.input.input.kinesisVideoStream?.arn,
            },
          },
          Output: {
            KinesisDataStream: {
              Arn: this.input.output.kinesisDataStream?.arn,
            },
          },
          Name: this.input.name,
          Settings: {
            FaceSearch: {
              CollectionId: this.input.settings.faceSearch?.collectionId,
              FaceMatchThreshold: this.input.settings.faceSearch?.faceMatchThreshold,
            },
          },
...
export class RekognitionDeleteCollection extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDeleteCollectionRequest) {
    super(scope, id);
  }
...
export class RekognitionDeleteFaces extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDeleteFacesRequest) {
    super(scope, id);
  }
...
export class RekognitionDeleteProject extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDeleteProjectRequest) {
    super(scope, id);
  }
...
export class RekognitionDeleteProjectVersion extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDeleteProjectVersionRequest) {
    super(scope, id);
  }
...
export class RekognitionDescribeCollection extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDescribeCollectionRequest) {
    super(scope, id);
  }
...
export class RekognitionDescribeProjectVersions extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDescribeProjectVersionsRequest) {
    super(scope, id);
  }
  ...
  public get projectVersionDescriptions(): shapes.RekognitionProjectVersionDescription[] {
    const props: cr.AwsCustomResourceProps = {
      ...
      onUpdate: {
        ...
        parameters: {
          ProjectArn: this.input.projectArn,
          VersionNames: this.input.versionNames,
...
export class RekognitionDescribeProjects extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDescribeProjectsRequest) {
    super(scope, id);
  }
...
export class RekognitionDescribeStreamProcessor extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDescribeStreamProcessorRequest) {
    super(scope, id);
  }
  ...
  public get input(): RekognitionDescribeStreamProcessorInput {
    return new RekognitionDescribeStreamProcessorInput(this, 'Input', this.__resources, this.input);
  }

  public get output(): RekognitionDescribeStreamProcessorOutput {
    return new RekognitionDescribeStreamProcessorOutput(this, 'Output', this.__resources, this.input);
  }
  ...
  public get settings(): RekognitionDescribeStreamProcessorSettings {
    return new RekognitionDescribeStreamProcessorSettings(this, 'Settings', this.__resources, this.input);
  }
...
export class RekognitionDescribeStreamProcessorInput extends cdk.Construct {
  ...
  public get kinesisVideoStream(): RekognitionDescribeStreamProcessorInputKinesisVideoStream {
    return new RekognitionDescribeStreamProcessorInputKinesisVideoStream(this, 'KinesisVideoStream', this.__resources, this.input);
  }
...
export class RekognitionDescribeStreamProcessorOutput extends cdk.Construct {
  ...
  public get kinesisDataStream(): RekognitionDescribeStreamProcessorOutputKinesisDataStream {
    return new RekognitionDescribeStreamProcessorOutputKinesisDataStream(this, 'KinesisDataStream', this.__resources, this.input);
  }
...
export class RekognitionDescribeStreamProcessorSettings extends cdk.Construct {
  ...
  public get faceSearch(): RekognitionDescribeStreamProcessorSettingsFaceSearch {
    return new RekognitionDescribeStreamProcessorSettingsFaceSearch(this, 'FaceSearch', this.__resources, this.input);
  }
...
export class RekognitionDetectCustomLabels extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDetectCustomLabelsRequest) {
    super(scope, id);
  }
      ...
      onUpdate: {
        ...
        parameters: {
          ...
          Image: {
            ...
            S3Object: {
              Bucket: this.input.image.s3Object?.bucket,
              Name: this.input.image.s3Object?.name,
              Version: this.input.image.s3Object?.version,
            },
          },
          MaxResults: this.input.maxResults,
          MinConfidence: this.input.minConfidence,
        },
      },
    };
...
export class RekognitionDetectFaces extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDetectFacesRequest) {
    super(scope, id);
  }
...
export class RekognitionDetectLabels extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDetectLabelsRequest) {
    super(scope, id);
  }
    ...
    const props: cr.AwsCustomResourceProps = {
      ...
      onUpdate: {
        ...
        parameters: {
          ...
          MaxLabels: this.input.maxLabels,
          MinConfidence: this.input.minConfidence,
        },
      },
    };
...
export class RekognitionDetectModerationLabels extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDetectModerationLabelsRequest) {
    super(scope, id);
  }
  ...
  public get humanLoopActivationOutput(): RekognitionDetectModerationLabelsHumanLoopActivationOutput {
    return new RekognitionDetectModerationLabelsHumanLoopActivationOutput(this, 'HumanLoopActivationOutput', this.__resources, this.input);
  }
...
export class RekognitionDetectProtectiveEquipment extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDetectProtectiveEquipmentRequest) {
    super(scope, id);
  }
      ...
      onUpdate: {
        ...
        parameters: {
          ...
          SummarizationAttributes: {
            MinConfidence: this.input.summarizationAttributes?.minConfidence,
            RequiredEquipmentTypes: this.input.summarizationAttributes?.requiredEquipmentTypes,
          },
        },
      },
    };
  ...
  public get summary(): RekognitionDetectProtectiveEquipmentSummary {
    return new RekognitionDetectProtectiveEquipmentSummary(this, 'Summary', this.__resources, this.input);
  }
...
export class RekognitionDetectText extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionDetectTextRequest) {
    super(scope, id);
  }
    ...
    const props: cr.AwsCustomResourceProps = {
      ...
      onUpdate: {
        ...
        parameters: {
          ...
          Filters: {
            WordFilter: {
              MinConfidence: this.input.filters?.wordFilter?.minConfidence,
              MinBoundingBoxHeight: this.input.filters?.wordFilter?.minBoundingBoxHeight,
              MinBoundingBoxWidth: this.input.filters?.wordFilter?.minBoundingBoxWidth,
            },
            RegionsOfInterest: this.input.filters?.regionsOfInterest,
          },
        },
      },
    };
...
export class RekognitionFetchCelebrityInfo extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionGetCelebrityInfoRequest) {
    super(scope, id);
  }
...
export class RekognitionFetchCelebrityRecognition extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionGetCelebrityRecognitionRequest) {
    super(scope, id);
  }
  ...
  public get videoMetadata(): RekognitionFetchCelebrityRecognitionVideoMetadata {
    return new RekognitionFetchCelebrityRecognitionVideoMetadata(this, 'VideoMetadata', this.__resources, this.input);
  }
...
export class RekognitionFetchContentModeration extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionGetContentModerationRequest) {
    super(scope, id);
  }
  ...
  public get videoMetadata(): RekognitionFetchContentModerationVideoMetadata {
    return new RekognitionFetchContentModerationVideoMetadata(this, 'VideoMetadata', this.__resources, this.input);
  }
...
export class RekognitionFetchFaceDetection extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionGetFaceDetectionRequest) {
    super(scope, id);
  }
  ...
  public get videoMetadata(): RekognitionFetchFaceDetectionVideoMetadata {
    return new RekognitionFetchFaceDetectionVideoMetadata(this, 'VideoMetadata', this.__resources, this.input);
  }
...
export class RekognitionFetchFaceSearch extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionGetFaceSearchRequest) {
    super(scope, id);
  }
  ...
  public get videoMetadata(): RekognitionFetchFaceSearchVideoMetadata {
    return new RekognitionFetchFaceSearchVideoMetadata(this, 'VideoMetadata', this.__resources, this.input);
  }
...
export class RekognitionFetchLabelDetection extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionGetLabelDetectionRequest) {
    super(scope, id);
  }
  ...
  public get videoMetadata(): RekognitionFetchLabelDetectionVideoMetadata {
    return new RekognitionFetchLabelDetectionVideoMetadata(this, 'VideoMetadata', this.__resources, this.input);
  }
...
export class RekognitionFetchPersonTracking extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionGetPersonTrackingRequest) {
    super(scope, id);
  }
  ...
  public get videoMetadata(): RekognitionFetchPersonTrackingVideoMetadata {
    return new RekognitionFetchPersonTrackingVideoMetadata(this, 'VideoMetadata', this.__resources, this.input);
  }
...
export class RekognitionFetchSegmentDetection extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionGetSegmentDetectionRequest) {
    super(scope, id);
  }
...
export class RekognitionFetchTextDetection extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionGetTextDetectionRequest) {
    super(scope, id);
  }
  ...
  public get videoMetadata(): RekognitionFetchTextDetectionVideoMetadata {
    return new RekognitionFetchTextDetectionVideoMetadata(this, 'VideoMetadata', this.__resources, this.input);
  }
...
export class RekognitionIndexFaces extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionIndexFacesRequest) {
    super(scope, id);
  }
    ...
    const props: cr.AwsCustomResourceProps = {
      ...
      onUpdate: {
        ...
        parameters: {
          ...
          ExternalImageId: this.input.externalImageId,
          DetectionAttributes: this.input.detectionAttributes,
          MaxFaces: this.input.maxFaces,
          QualityFilter: this.input.qualityFilter,
        },
      },
    };
...
export class RekognitionListCollections extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionListCollectionsRequest) {
    super(scope, id);
  }
...
export class RekognitionListFaces extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionListFacesRequest) {
    super(scope, id);
  }
...
export class RekognitionListStreamProcessors extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionListStreamProcessorsRequest) {
    super(scope, id);
  }
...
export class RekognitionRecognizeCelebrities extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionRecognizeCelebritiesRequest) {
    super(scope, id);
  }
...
export class RekognitionSearchFaces extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionSearchFacesRequest) {
    super(scope, id);
  }
  ...
  public get searchedFaceId(): string {
    const props: cr.AwsCustomResourceProps = {
      ...
      onUpdate: {
        ...
        parameters: {
          CollectionId: this.input.collectionId,
          FaceId: this.input.faceId,
          MaxFaces: this.input.maxFaces,
          FaceMatchThreshold: this.input.faceMatchThreshold,
        },
      },
    };
...
export class RekognitionSearchFacesByImage extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionSearchFacesByImageRequest) {
    super(scope, id);
  }

  public get searchedFaceBoundingBox(): RekognitionSearchFacesByImageSearchedFaceBoundingBox {
    return new RekognitionSearchFacesByImageSearchedFaceBoundingBox(this, 'SearchedFaceBoundingBox', this.__resources, this.input);
  }
...
export class RekognitionStartCelebrityRecognition extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionStartCelebrityRecognitionRequest) {
    super(scope, id);
  }
    ...
    const props: cr.AwsCustomResourceProps = {
      ...
      onUpdate: {
        ...
        parameters: {
          Video: {
            S3Object: {
              Bucket: this.input.video.s3Object?.bucket,
              Name: this.input.video.s3Object?.name,
              Version: this.input.video.s3Object?.version,
            },
          },
...
export class RekognitionStartContentModeration extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionStartContentModerationRequest) {
    super(scope, id);
  }
...
export class RekognitionStartFaceDetection extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionStartFaceDetectionRequest) {
    super(scope, id);
  }
    ...
    const props: cr.AwsCustomResourceProps = {
      ...
      onUpdate: {
        ...
        parameters: {
          ...
          FaceAttributes: this.input.faceAttributes,
          JobTag: this.input.jobTag,
        },
      },
    };
...
export class RekognitionStartFaceSearch extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionStartFaceSearchRequest) {
    super(scope, id);
  }
...
export class RekognitionStartLabelDetection extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionStartLabelDetectionRequest) {
    super(scope, id);
  }
...
export class RekognitionStartPersonTracking extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionStartPersonTrackingRequest) {
    super(scope, id);
  }
...
export class RekognitionStartProjectVersion extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionStartProjectVersionRequest) {
    super(scope, id);
  }
  ...
  public get status(): string {
    const props: cr.AwsCustomResourceProps = {
      ...
      onUpdate: {
        ...
        parameters: {
          ProjectVersionArn: this.input.projectVersionArn,
          MinInferenceUnits: this.input.minInferenceUnits,
        },
      },
    };
...
export class RekognitionStartSegmentDetection extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionStartSegmentDetectionRequest) {
    super(scope, id);
  }
    ...
    const props: cr.AwsCustomResourceProps = {
      ...
      onUpdate: {
        ...
        parameters: {
          ...
          Filters: {
            TechnicalCueFilter: {
              MinSegmentConfidence: this.input.filters?.technicalCueFilter?.minSegmentConfidence,
            },
            ShotFilter: {
              MinSegmentConfidence: this.input.filters?.shotFilter?.minSegmentConfidence,
            },
          },
          SegmentTypes: this.input.segmentTypes,
        },
      },
    };
...
export class RekognitionStartTextDetection extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionStartTextDetectionRequest) {
    super(scope, id);
  }
...
export class RekognitionStopProjectVersion extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, private readonly __resources: string[], private readonly input: shapes.RekognitionStopProjectVersionRequest) {
    super(scope, id);
  }
