...
export * as amp from './clients/amp';
export * as amplify from './clients/amplify';
export * as amplifybackend from './clients/amplifybackend';
...
export * as chimesdkidentity from './clients/chimesdkidentity';
export * as chimesdkmessaging from './clients/chimesdkmessaging';
...
export * as connectcontactlens from './clients/connectcontactlens';
export * as connectparticipant from './clients/connectparticipant';
export * as cur from './clients/cur';
export * as customerprofiles from './clients/customerprofiles';
...
export * as devopsguru from './clients/devopsguru';
...
export * as ecrpublic from './clients/ecrpublic';
...
export * as emrcontainers from './clients/emrcontainers';
export * as es from './clients/es';
export * as eventbridge from './clients/eventbridge';
export * as finspace from './clients/finspace';
export * as finspacedata from './clients/finspacedata';
export * as firehose from './clients/firehose';
export * as fis from './clients/fis';
...
export * as greengrassv2 from './clients/greengrassv2';
...
export * as healthlake from './clients/healthlake';
...
export * as iotdeviceadvisor from './clients/iotdeviceadvisor';
export * as iotevents from './clients/iotevents';
export * as ioteventsdata from './clients/ioteventsdata';
export * as iotfleethub from './clients/iotfleethub';
...
export * as iotwireless from './clients/iotwireless';
...
export * as location from './clients/location';
export * as lookoutequipment from './clients/lookoutequipment';
export * as lookoutmetrics from './clients/lookoutmetrics';
export * as lookoutvision from './clients/lookoutvision';
...
export * as mgn from './clients/mgn';
...
export * as nimble from './clients/nimble';
...
export * as proton from './clients/proton';
...
export * as route53recoverycluster from './clients/route53recoverycluster';
export * as route53recoverycontrolconfig from './clients/route53recoverycontrolconfig';
export * as route53recoveryreadiness from './clients/route53recoveryreadiness';
...
export * as sagemakeredge from './clients/sagemakeredge';
export * as sagemakerfeaturestoreruntime from './clients/sagemakerfeaturestoreruntime';
...
export * as ssmcontacts from './clients/ssmcontacts';
export * as ssmincidents from './clients/ssmincidents';
...
export * as wellarchitected from './clients/wellarchitected';
